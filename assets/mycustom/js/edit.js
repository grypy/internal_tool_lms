     ...
     var append = '  <form class="frm_edititem">\
						...
						<div class="form-group">\
							...
							<select name="e_category" class="form-control" required>\
								...
								<option>Wireless systems lab</option>\
								<option>Energy systems lab</option>\
								<option>Tiny ML & AI Lab</option>\
								<option>Robotics Lab</option>\
								<option>CyLab & Networking Lab</option>\
...
table_member.on('click', 'a.edit-member', function(e){
	...
	var form = '<form class="frm_student_sign">\
					...
					<div class="form-group">\
						...
						<input type="text" name="sid_number" value="'+tr[0]+'" class="form-control" required autocomplete="off">\
					</div>\
					<div class="form-group">\
	...
	var form = '<form class="edit_user">\
				...
				<div class="form-group">\
					...
					<select class="form-control" name="u_type" required="required">\
						...
						<option value="3">Lab Coordinator</option>\
