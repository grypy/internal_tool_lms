	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">CMU Africa Labs</a>
			</div>
			...
			<div class="col-md-4 col-sm-12 col-xs-12 col-md-offset-4">
				<form class="frm_student_sign">
					...
					<div class="form-group">
						<label>Andrew ID</label>
						<input type="text" name="sid_number" class="form-control" required autocomplete="off">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="email" name="s_contact" class="form-control" required autocomplete="off">
					</div>
					<div class="form-group">
				...
				<form class="frm_faculty_sign hide">
					...
					<div class="form-group">
						<label>Email Address</label>
						<input type="email" name="f_contact" class="form-control" required autocomplete="off">
					</div>
					<div class="form-group">
						<label>Department</label>
						<select name="s_department" class="form-control" required>
